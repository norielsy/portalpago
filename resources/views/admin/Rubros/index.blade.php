...
@include('admin.Rubros.modal_editar')
@include('admin.Rubros.modal_eliminar')
...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::open(['method' => 'POST','id' => 'form_registro_main','class'=>'form-signin wow fadeInUp','action' => 'Admin\RubrosController@agregarpost']) !!}
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($tabla as $data)
                                <tr>
                                    ...
                                    <td>{{$data->nombre}}</td>
                                    <td>
                                        <a href="javascript:;" class="modal_edit" attr-id="{{$data->idrubros}}">
                                            <i class="icono-verde fa fa-pencil-square-o "></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="javascript:;" class="modal_elimitar" attr-id="{{$data->idrubros}}">
    ...
    <script src="{{ asset('public/js/admin/rubros.js')}}"></script>
@endsection