@section('modal_editar')
    <div id="" class="modal_editar modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['method' => 'POST','id' => 'form_editar','class'=>'form-signin','action' => 'Admin\PublicidadController@editar','files' => true]) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('fecha_inicio',null,['class' => 'form-control','id' => 'from_edit']) !!}
                            </div>

                            <div class="form-group">
                                <label>Fecha Término</label>
                                {!! Form::text('fecha_fin',null,['class' => 'form-control','id' => 'to_edit']) !!}
                            </div>
