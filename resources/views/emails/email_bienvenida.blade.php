            ...
            <table style="width:100%; border-collapse:collapse; background:#fff; padding: 30px 35px;">
                ...
                <tr>
                    <td style="padding: 30px 35px;">
                        ...
                        <p style="font-size: 16px; font-weight:normal; margin-bottom:20px;"><strong>¡Bienvenido/a a Portal de Pagos!</strong> </p>
                      

                        <p style="font-size: 16px; font-weight:normal; margin-bottom:20px;">Para activar tu cuenta ingresa en el botón de abajo. </p>
            ...
            <table style="width:100%; border-collapse:collapse;">
                <tr>
                    <td class="footer" style="background:#efefef; padding:30px 35px;" align="center">
                        <p style="margin-bottom:0; text-align:center; font-size:14px;">Portal de Pagos. <strong>Fácil</strong> para quien paga. <strong>Eficiente</strong> para quien cobra.
</p>
                        <p><a style="color:#888; text-decoration:none;" href="http://www.portaldepagos.cl">www.portaldepagos.cl</a></p>
                    </td>
                </tr>
            </table>
