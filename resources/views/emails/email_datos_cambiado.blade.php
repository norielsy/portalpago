            ...
            <table style="width:100%; border-collapse:collapse; background:#fff; padding: 30px 35px;">
                ...
                <tr>
                    <td style="padding: 30px 35px;">
                        ...
                        <p style="font-size: 16px; font-weight:normal; margin-bottom:20px;">Informamos que el cambio de tus datos en nuestros registros fue realizado de forma exitosa.</p>
