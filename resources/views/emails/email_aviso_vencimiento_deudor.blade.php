            ...
            <table style="width:100%; border-collapse:collapse; background:#fff; padding: 30px 35px;">
                ...
                <tr>
                    <td style="padding: 30px 35px;">
                        ...
                        <h2 style="font-size:28px; margin-bottom:20px; line-height: 1.25;">Vencimiento de deudas</h2>
                        <p style="font-size: 16px; font-weight:normal; margin-bottom:20px;">Hola <em style="color:#71bc37; font-weight:bold;">{{$nombre}}</em></p>


                        <p style="font-size: 16px; font-weight:normal; margin-bottom:20px;">su cuenta ya está vencida por <strong>{{$dia }} día(s)</strong></p>
                        <p>Para más información entra a:</p>
                            ...
                            <tr>
                                <td align="center">
                                    <p style="font-size: 16px; font-weight:normal; margin-bottom:20px;">
                                        <a href="http://portaldepagos.cl/consultar" style="width:200px; border-radius: 4px; font-weight:bold; padding:15px 20px 15px; text-decoration:none; background:#71bc37; color:#fff; display: inline-block;">Consultar Pagos Pendientes</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td>
                        <div style="text-align: center; padding:15px; font-size: 10px;">
                            <p><strong>Este es un mensaje automático:</strong> Si el pago ya fue realizado, no considere este mensaje.</p>
    ...
    <tr>
       <td class="container" style="display:block; clear:both!important; margin:0 auto!important; max-width:580px!important;">
            ...
            <table style="width:100%; border-collapse:collapse;">
                <tr>
                    <td class="footer" style="background:#efefef; padding:30px 35px;" align="center">
                        <p style="margin-bottom:0; text-align:center; font-size:14px;">Portal de Pagos. <br><strong>Fácil</strong> para quien paga. <strong>Eficiente</strong> para quien cobra.<br/>
</p>
            ...
            <div style="text-align: justify; padding:30px; font-size: 10px;">
                <strong>Aviso Legal:</strong> La información generada en este e-mail no es de responsabilidad de Portal de Pagos - Soluciones de Pagos SPA. Si no estás de acuerdo con el monto, fecha de vencimiento o cualquier otra información sobre este cobro, solicitamos contactar directamente a la empresa o persona que lo generó.
