            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="hidden-lg hidden-md hidden-sm">
                        <a class="p_mi_cuenta" href="{{asset('dashboard')}}">
                            Resumen
                        </a>
                    </li>
                    <li class="hidden-lg hidden-md hidden-sm">
...
<div class="breadcrumbs">
    <div class="container">
        <div class="row">
            ...
            <li>
                <a href="{{asset('dashboard')}}"  role="button"
                aria-haspopup="true" aria-expanded="false">Resumen <span class="p_mi_cuenta"></span></a>
            </li>
